...
2. Create a bluenose directory and an assn1 subdirectory on the unix server
      ...
      mkdir -p csci3136/assn9

3. Change directories into assn9

      cd csci3136/assn9

4. Copy (upload) the tests_9.zip file to csci3136/assn9 on the unix 
   server.
...
6a. Run the script files to run the tests.
